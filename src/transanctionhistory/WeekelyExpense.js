...
const WeekelyExpense = () => {

	const url = 'http://localhost:8888/myexpense/getAllExpensesReport/weekly'
		...
		<div>
			...
			<div style={{ padding: "10px 20px", justifyContent: 'left' }} >
				...
				<div class="bg-danger text-white">
						<CSVLink className="downloadbtn" filename="weeklyexpense.csv" data={csvData}>
							Export to CSV
						</CSVLink>
					</div>
				</div>
